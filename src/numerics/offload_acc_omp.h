...
#define GPU_PARALLEL_LOOP_ALL_LEVELS_COLLAPSE2 MY_PRAGMA(omp simd) 
...
#ifdef _OPENMP
#define GPU_PARALLEL_LOOP_ALL_LEVELS_COLLAPSE2 MY_PRAGMA(omp target teams distribute parallel for simd collapse(2))
...
#define NWORKERS 8
#define NVECTORS 32
#define GPU_PARALLEL_LOOP_ALL_LEVELS_COLLAPSE2 MY_PRAGMA(acc parallel loop collapse(2))
