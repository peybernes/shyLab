#ifndef KERNEL_DIRECT_PROJECTION_CORNER_FLUXES_2D_H
#define KERNEL_DIRECT_PROJECTION_CORNER_FLUXES_2D_H
...
void ReconstructMassFluxOrder2Corner(index_t nx, 
				     index_t ny,
				     RealType dx,
				     RealType dy,
				     RealType dt,
...
void ReconstructMassFluxOrder2DiagCorner(index_t nx, 
					 index_t ny,
					 RealType dx,
					 RealType dy,
					 RealType dt,
...
void ProjectMassCornerFluxes(index_t nx, 
			     index_t ny, 
			     RealType dt,
...
void ReconstructIntensiveVariableFluxOrder2Corner(index_t nx, 
						  index_t ny,
						  RealType dx,
						  RealType dy,
						  RealType dt,
...
void ReconstructIntensiveVariableFluxOrder2DiagCorner(index_t nx, 
						      index_t ny,
						      RealType dx,
						      RealType dy,
						      RealType dt,
...
#endif // KERNEL_DIRECT_PROJECTION_CORNER_FLUXES_2D_H
