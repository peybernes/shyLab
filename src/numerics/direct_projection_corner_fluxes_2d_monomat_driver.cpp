...
void DirectProjectionCornerFluxes2dMonomaterialDriver(//in
  ...
  clock_gettime(CLOCK_REALTIME, &time_begin);
  ReconstructGradientDiag(nx, ny, dx, dy, dt, predicted_u, predicted_v, directional_lagrangian_density, density_gradient_diag, density_gradient_antidiag);
  time_gradient_X.push_back(diff(time_begin, time_end));
  time_gradient_Y.push_back(diff(time_begin, time_end));   
  ...
  clock_gettime(CLOCK_REALTIME, &time_begin);
  ReconstructGradientDiagBoundary(BoundaryConditions, nx, ny, dx, dy, dt, predicted_u, predicted_v, directional_lagrangian_density, density_gradient_diag, density_gradient_antidiag);
  time_periodic_boundary.push_back(diff(time_begin, time_end));
  ...
  #include "reconstruct_density_monomat.h"
