      ...
      const RealType in_vx_m1 = in_vx[node_om1];
      const RealType in_vx_p1 = in_vx[node_op1];

      const RealType cell_mass_m1m1 = in_cell_mass[cellm1m1];
      const RealType cell_mass_p1m1 = in_cell_mass[cellp1m1];
      const RealType cell_mass_m1p1 = in_cell_mass[cellm1p1];
      const RealType cell_mass_p1p1 = in_cell_mass[cellp1p1];
